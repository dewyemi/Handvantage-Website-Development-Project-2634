...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE.baseUrl}/partners`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE.baseUrl}/healthcare`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE.baseUrl}/fintech`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE.baseUrl}/government`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE.baseUrl}/legal`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${SITE.baseUrl}/biotech`, lastModified: today, changeFrequency: "monthly", priority: 0.85 },
