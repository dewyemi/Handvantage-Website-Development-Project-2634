...
**Active queue (19 topics, interleaved)**:

The 2026-05 voice rebalance (DESIGN.md §5) added a category: business-value field notes that sit alongside the regulatory briefings. Three of these are folded into the queue at positions 1, 5, and 9 so the routine surfaces business-buyer content early in the cadence rather than waiting for the regulatory briefings to clear.

1. **FIELD NOTE — Vendor consolidation math: replacing eight productivity tools with one** · Targets: "vendor consolidation AI", "AI vendor sprawl". *The contract surface, security review burden, and renewal-cycle cost of running eight productivity vendors — and which of those costs go away when the productivity stack consolidates. Honest about what does NOT consolidate (identity, SIEM).*
2. **BRIEFING — AIDA explained: what Canadian enterprises need to do before enactment** · Targets: "AIDA Canada", "AI and Data Act". *AIDA's current draft, the high-impact AI definition, and what the proposed ISED powers mean for procurement.*
3. **RETROSPECTIVE — Why we ripped out configurable defence layers** · Targets: "agentic AI architecture", "secure by design". *The early version of the 7-Layer Defence let operators turn layers off. The audit log was contestable. We rebuilt as structural. Here's what it cost.*
4. **DOSSIER — Healthcare and agentic AI: HIPAA, FDA SaMD, and the supervision question** · Targets: "AI healthcare compliance", "FDA SaMD AI". *Three regulatory frames a healthcare buyer has to satisfy simultaneously, and what the platform's posture covers vs. what the customer still owns.*
5. **FIELD NOTE — How to brief your CFO on agentic AI without overpromising** · Targets: "AI ROI CFO", "AI business case". *A small set of questions and prepared answers that get a CFO from "AI is a buzzword" to "I can defend this line item." Particularly useful when the AI line item doesn't yet have a name.*
6. **FIELD NOTE — Why we stopped saying "AI agents" in security reviews** · Targets: vocabulary essay; trust signal. *The vocabulary we use in vendor reviews and why it changed.*
7. **BRIEFING — NIST AI RMF Govern function: the controls most platforms skip** · Targets: "NIST AI RMF Govern", "NIST AI RMF compliance". *The Govern function's six categories and which ones get systematically ignored in vendor self-attestation.*
8. **RETROSPECTIVE — From SaaS to single-tenant: the deployment decision** · Targets: "single-tenant AI platform", "data sovereignty AI". *Why we don't run a multi-tenant data lake — and what we lose by not running one.*
9. **FIELD NOTE — What agentic AI actually does for sales velocity** · Targets: "agentic AI sales", "AI proposal automation". *The mechanics of how proposals get drafted faster — by which agent doing which work — without claiming a number we can't verify. The compounding effect on rep time.*
10. **DOSSIER — Public sector AI procurement: GSA, FedRAMP, and the EU GovTech corridor** · Targets: "AI procurement government", "FedRAMP government AI". *Two procurement paths (US federal + EU public sector) and how they shape what we have to ship.*
11. **FIELD NOTE — Three questions to ask a vendor about their audit log** · Targets: "AI vendor due diligence", "AI audit log questions". *A short pre-flight checklist a CISO can run on any agentic AI vendor in 10 minutes.*
12. **BRIEFING — OWASP Top 10 for Agentic Applications: a security architect's reading guide** · Targets: "OWASP agentic AI", "OWASP LLM Top 10". *Each category translated into "what this looks like in production" and "what controls actually catch it."*
13. **RETROSPECTIVE — Pilot + Fleet at runtime: what we changed after the first three deployments** · Targets: "Pilot Fleet model", "agentic AI permission model". *Three customer deployments, three changes to how Pilot delegates and how the Fleet declares scope.*
14. **DOSSIER — Legal services and agentic AI: ABA Model Rule 1.1 and the supervision standard** · Targets: "AI legal compliance", "ABA Model Rule AI". *The ABA's competence rule + the State Bar guidance, read against agentic AI deployment in BigLaw.*
15. **FIELD NOTE — Reading the FTC's AI guidance like a CISO would** · Targets: "FTC AI guidance", "AI deceptive practices". *The FTC's 2025–2026 enforcement pattern (Rytr, DoNotPay, Workado) and what it means for procurement language.*
16. **BRIEFING — PCI DSS v4.0 and agentic AI: where the controls don't map cleanly** · Targets: "PCI DSS AI", "PCI DSS v4.0 LLM". *The three v4.0 controls (8.6, 11.5.1, 12.10.5) that have non-obvious implications for agentic AI environments.*
17. **RETROSPECTIVE — A Layer 4 false positive in the embedding-inversion probe** · Targets: "embedding inversion", "memory safety AI". *A real false positive we caught in pre-prod, what triggered it, and how we tightened the probe corpus without losing detection rate.*
18. **BRIEFING — FedRAMP for AI workloads: what's different about high-risk agents** · Targets: "FedRAMP AI", "FedRAMP agentic". *FedRAMP Moderate baseline + the 2025 Emerging Technology Security Requirements update for AI workloads.*
19. **BRIEFING — The HIPAA "minimum necessary" standard and AI agents** · Targets: "HIPAA AI", "HIPAA minimum necessary AI". *What "minimum necessary" means when the agent is an autonomous decision-maker, not a human operator.*
