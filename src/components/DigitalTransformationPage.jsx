  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Reset form
        setFormData({firstName: '', lastName: '', email: '', phone: '', company: '', transformationChallenges: ''});
            ...
            {solutionCategories.map((solution, index) => (
              ...
              >
                ...
                <div className="md:col-span-10">
                  ...
                  <h4 className="font-semibold text-primary-dark mb-3">Strategic Business Advantages:</h4>
            ...
            >
              ...
              <div className="mb-6">
                ...
                <ul className="grid md:grid-cols-2 gap-y-2 gap-x-4 text-left">
                  ...
                  <li className="flex items-center">
                    <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-blue-200 mr-2" />
                    <span>Competitive advantage opportunities</span>
                  </li>
                  <li className="flex items-center">
                    <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-blue-200 mr-2" />
                    <span>Strategic business roadmap</span>
                  </li>
                  <li className="flex items-center">
                    <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-blue-200 mr-2" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-slate-300 mb-8">
                Fill out the form below to schedule your free 30-minute strategic growth assessment with Josh to identify your business bottlenecks and competitive advantage opportunities.
              </p>
              ...
              {formStatus.isSuccess && (
                ...
                >
                  <div className="flex items-center">
                    ...
                    <span>Thank you for your interest in strategic technology consulting. We'll contact you within 24 hours to discuss how we can eliminate the bottlenecks limiting your growth.</span>
                  </div>
                </motion.div>
              )}
              ...
              >
                ...
                <div>
                  <label htmlFor="transformationChallenges" className="block text-sm font-medium text-slate-300 mb-1">
                    What growth bottlenecks are you currently experiencing?
                  </label>
                  <textarea 
                ...
                >
                  {formStatus.isSubmitting ? (
                    ...
                    'Schedule My Growth Bottleneck Assessment'
                  )}
                </motion.button>
              </form>
            </motion.div>
            ...
            >
              <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
                ...
                <p className="text-primary-blue font-semibold mb-4">Strategic Technology Consultant</p>
                ...
                <blockquote className="text-slate-300 italic mb-6 text-sm">
                  "I've helped businesses of all sizes eliminate their growth bottlenecks and create competitive advantages. Let me show you how strategic technology planning can transform your business."
                </blockquote>
