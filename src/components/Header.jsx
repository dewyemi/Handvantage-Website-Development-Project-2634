              ...
              >
                {item.hasDropdown ? (
                  <div className="group">
                    ...
                    {/* Dropdown Menu */}
                    <div
                      className={`absolute top-full left-0 bg-white shadow-lg rounded-lg py-3 w-60 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 ${isServicesOpen ? 'opacity-100 visible' : ''}`}
                    >
