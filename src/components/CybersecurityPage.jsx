...
const CybersecurityPage = () => {
  ...
  const assessmentSteps = [
    {
      ...
      description: "Complete inventory of systems, networks, and applications",
      color: "#dc2626"
    },
    {
      number: "2",
      title: "Vulnerability Assessment",
      description: "Identify security weaknesses and potential attack vectors",
      color: "#f59e0b"
    },
    {
      number: "3",
      title: "Compliance Gap Analysis",
      description: "Assess current compliance status against required frameworks",
      color: "#2563eb"
    },
    {
      number: "4",
      title: "Risk Prioritization",
      description: "Rank risks by business impact and likelihood",
      color: "#16a34a"
    },
    {
      number: "5",
      title: "Remediation Roadmap",
      description: "Detailed plan for addressing identified security gaps",
      color: "#7c3aed"
    }
  ];
  ...
  const assessmentDeliverables = [
    ...
    },
    {
      ...
      title: "Vulnerability Assessment",
      description: "Detailed analysis of security weaknesses and risks",
      color: "#dc2626"
    },
    {
      icon: FiCheckSquare,
      title: "Compliance Status Report",
      description: "Current compliance posture and gap analysis",
      color: "#16a34a"
    },
    {
      icon: FiTrendingUp,
      title: "Risk Prioritization Matrix",
      description: "Risks ranked by business impact and urgency",
      color: "#f59e0b"
    },
    {
      icon: FiMap,
      title: "Security Roadmap",
      description: "90-day, 6-month, and 1-year implementation plan",
      color: "#7c3aed"
    },
    {
      icon: FiDollarSign,
      title: "ROI Projections",
      description: "Cost-benefit analysis for recommended solutions",
      color: "#059669"
    }
  ];
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-red-100 mb-8">
              Every day without proper security protection puts your business at risk. Get enterprise-grade security today with our partnership-powered solutions.
            </p>
              ...
              <div className="mb-6">
                ...
                <ul className="grid md:grid-cols-2 gap-y-2 gap-x-4 text-left">
                  <li className="flex items-center">
                    ...
                    <span>Complete vulnerability assessment</span>
                  </li>
                  <li className="flex items-center">
                    <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-red-200 mr-2" />
                    <span>Multi-layered security solution recommendations</span>
                  </li>
                  <li className="flex items-center">
                    <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-red-200 mr-2" />
                    <span>Compliance gap analysis and roadmap</span>
                  </li>
                  <li className="flex items-center">
                    <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-red-200 mr-2" />
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold mb-6">Schedule Your Security Assessment</h2>
              ...
              <div className="bg-slate-800 rounded-2xl p-8 border border-slate-700">
                ...
                <div className="bg-red-900/30 p-4 rounded-lg mb-6">
                  ...
                  <ul className="text-slate-300 space-y-2">
                    ...
                    <li className="flex items-center justify-center">
                      <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-green-400 mr-2" />
                      <span>Data recovery assistance</span>
                    </li>
                    <li className="flex items-center justify-center">
                      <SafeIcon icon={FiCheckCircle} className="w-5 h-5 text-green-400 mr-2" />
