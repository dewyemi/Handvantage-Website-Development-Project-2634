  ...
  const careerTimeline = [
    {
      ...
      icon: FiShield,
      iconBg: '#ff9500',
      description: `Josh's career spans across Finance, Utility, Telecoms, Service Provider, Government and top Tech companies like Amazon and Oracle, working on enterprise-scale IT, security implementations and multi-million dollar Digital Transformation projects. This experience taught him how to design and deploy technologies and security solutions that accelerate business growth and protect massive, complex infrastructures while maintaining operational efficiency.`,
      achievements: [
    ...
    },
    {
      ...
      icon: FiDatabase,
      iconBg: '#f80000',
      description: `At Oracle, Josh expanded his expertise beyond security into complete business technology solutions. He learned how to align technology investments with business objectives and drive digital transformation initiatives that deliver measurable ROI and competitive advantage.`,
      achievements: [
    ...
    },
    {
      ...
      icon: FiCloud,
      iconBg: '#ff9900',
      description: `Josh's role at AWS positioned him at the forefront of cloud transformation. He helped businesses migrate to the cloud while maintaining security and compliance, giving him deep expertise in modern cloud architectures and scalability planning for high-growth organizations.`,
      achievements: [
    ...
    },
    {
      ...
      icon: FiBuilding,
      iconBg: '#16a34a',
      description: `Josh took his enterprise expertise and applied it to the real world by starting and operating his own Managed Service Provider. This experience taught him the challenges that growing businesses face and how to deliver enterprise-grade solutions at SME scale without the complexity and cost that typically come with enterprise implementations.`,
      achievements: [
  ...
  const partnershipCategories = [
    {
      ...
      color: '#2563eb',
      partners: [
        {name: 'Microsoft Cloud Solution Provider', description: 'Direct access to Microsoft 365, Azure, and enterprise solutions'},
        {name: 'RTILA AI Master Agent', description: 'Cutting-edge business automation and AI implementation'},
    ...
    },
    {
      ...
      color: '#dc2626',
      partners: [
        {name: 'IRONSCALES Partner', description: 'Email security protecting 16,000+ organizations worldwide'},
        {name: 'Check Point Certified', description: 'Next-generation firewall and network security solutions'},
        {name: 'Vanta Specialist', description: 'Automated compliance for SOC 2, HIPAA, ISO 27001'},
        {name: 'Swif.ai Partner', description: 'AI-powered device management and Shadow IT visibility'}
      ]
    },
    {
      ...
      color: '#16a34a',
      partners: [
        {name: 'Intermedia Partner', description: 'Unified communications and VoIP solutions'},
        {name: 'Additional Cloud Partners', description: 'Access to 200+ solutions through strategic partnerships'},
        {name: 'Direct Vendor Relationships', description: 'Preferred pricing and support for all solutions'}
      ]
    }
  ];
              ...
              >
                ...
                >
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg text-primary-dark">Strategic Business Focus</h3>
                      <p className="text-slate-600">Identifies business bottlenecks and turns technology into competitive advantage</p>
                    </div>
                  </div>
                </motion.div>
