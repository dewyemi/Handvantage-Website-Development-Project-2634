          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="bg-white rounded-3xl p-8 shadow-xl">
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <h2 className="text-3xl font-bold text-primary-dark mb-2">Josh Olayemi</h2>
            ...
            >
              ...
              <motion.h1
                ...
                viewport={{ once: true }}
              >
                The Complete Technology Expert You've Been Looking For
              </motion.h1>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <div className="bg-white rounded-xl p-8 border-l-4 border-primary-blue shadow-lg relative">
              ...
              <p className="text-lg text-slate-600 italic relative z-10">
              ...
              <p className="text-right text-primary-blue font-semibold mt-4">
            ...
            >
              <div className="bg-primary-light rounded-xl p-8">
                ...
                <div className="bg-white rounded-xl p-6">
                  <p className="text-slate-600 italic text-center mb-4">
