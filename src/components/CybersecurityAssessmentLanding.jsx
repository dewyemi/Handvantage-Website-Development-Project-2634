...
const { 
  ...
  FiXCircle, FiClock, FiTarget, FiPhone, FiUser, FiFileText,
  FiRefreshCw, FiDollarSign, FiTrendingUp, FiEye, FiActivity
} = FiIcons;
...
const CybersecurityAssessmentLanding = () => {
  const securityDomains = [
    {
      ...
      description: "Phishing protection, user training, encryption, and threat response",
      color: "#dc2626"
    },
    {
      icon: FiShield,
      title: "Network Security", 
      description: "Firewall protection, intrusion detection, VPN security, and monitoring",
      color: "#7c2d12"
    },
    {
      icon: FiMonitor,
      title: "Endpoint Protection",
      description: "Device management, antivirus, encryption, and mobile security",
      color: "#991b1b"
    },
    {
      icon: FiFileText,
      title: "Compliance & Governance",
      description: "HIPAA, SOC 2, access controls, and audit logging",
      color: "#be123c"
    },
    {
      icon: FiRefreshCw,
      title: "Business Continuity",
      description: "Backup procedures, disaster recovery, and crisis management",
      color: "#9f1239"
    }
  ];
  ...
  const riskLevels = [
    ...
    {
      level: "High Risk",
      range: "200-299 Points", 
      description: "Significant vulnerabilities requiring urgent attention",
      color: "#f97316",
      icon: FiAlertTriangle
    },
    {
      level: "Moderate Risk",
      range: "300-399 Points",
  ...
  const threatStatistics = [
    {
      stat: "95%",
      description: "of cyberattacks start with email",
      icon: FiMail,
      color: "#dc2626"
    },
    {
    ...
    {
      stat: "277 days",
      description: "average time to identify a breach",
      icon: FiClock,
      color: "#dc2626"
    },
    {
  ...
  const partnerSolutions = [
    {
      ...
      description: "AI-powered email security protecting 16,000+ organizations",
      benefits: ["Advanced phishing protection", "Automated incident response", "User training integration"],
      color: "#f59e0b"
    },
    {
      partner: "Check Point",
      ...
      benefits: ["Network intrusion prevention", "VPN security", "Threat intelligence"],
      color: "#dc2626"
    },
    {
      partner: "Swif.ai",
      solution: "Device Management",
      description: "AI-powered device visibility and Shadow IT discovery",
      benefits: ["Complete device inventory", "Shadow IT detection", "Compliance monitoring"],
      color: "#2563eb"
    },
    {
      partner: "Vanta",
      ...
      benefits: ["Continuous monitoring", "Automated evidence collection", "Audit preparation"],
      color: "#16a34a"
    }
  ];
  ...
  const industryThreats = [
    {
      industry: "Healthcare",
      threats: ["HIPAA violations", "Ransomware attacks", "Patient data theft"],
      compliance: "HIPAA, HITECH"
    },
    {
      industry: "Financial Services", 
      threats: ["Payment fraud", "Data breaches", "Regulatory fines"],
      compliance: "PCI DSS, SOX"
    },
    {
      industry: "Legal",
      threats: ["Client confidentiality breaches", "Ransomware", "Privilege violations"],
      compliance: "Attorney-client privilege"
    },
    {
      industry: "Manufacturing",
      threats: ["Industrial espionage", "Supply chain attacks", "IP theft"],
    ...
    <div className="pt-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div>
                ...
                >
                  Identify Critical Security
                  <span className="bg-gradient-to-r from-red-400 to-orange-400 bg-clip-text text-transparent"> Vulnerabilities</span>
                </motion.h1>
                ...
                >
                  Comprehensive 25-question assessment across 5 critical security domains. Get your risk score, vulnerability analysis, and personalized security roadmap.
                </motion.p>
              </div>
              ...
              >
                ...
                >
                  ...
                  <SafeIcon icon={FiShield} className="w-5 h-5 ml-2" />
                </Link>
            ...
            >
              <div className="bg-slate-800 rounded-2xl shadow-xl p-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-white mb-2">Security Assessment Domains</h3>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our weighted scoring system evaluates your security posture across all domains
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-slate-800">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-4xl font-bold text-white mb-4">
              Industry-Specific Security Threats
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  ...
                  <ul className="space-y-1">
                    {industry.threats.map((threat, i) => (
                      <li key={i} className="text-sm text-gray-300 flex items-center">
                        <SafeIcon icon={FiAlertTriangle} className="w-3 h-3 text-red-400 mr-2" />
                        {threat}
                      </li>
                    ))}
                  </ul>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-4xl font-bold text-white mb-4">
              Partnership-Powered Security Solutions
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Based on your assessment results, we recommend specific partner solutions
            </p>
          </motion.div>
                ...
                <ul className="space-y-2">
                  {solution.benefits.map((benefit, i) => (
                    <li key={i} className="flex items-center text-sm text-gray-300">
                      <SafeIcon icon={FiCheckCircle} className="w-4 h-4 mr-2" style={{ color: solution.color }} />
                      {benefit}
                    </li>
                  ))}
                </ul>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Take our comprehensive cybersecurity risk assessment and get your personalized security roadmap today.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              >
                ...
                Emergency Security: 236-235-0919
              </motion.a>
            </div>
