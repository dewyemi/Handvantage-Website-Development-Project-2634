...
const Services=()=> {
  ...
  const assessments=[ 
    ...
    {icon: FiShield,
     ...
     description: 'Comprehensive business protection analysis that identifies security gaps threatening your growth and provides strategic protection roadmap',
     features: ['Business protection strategy','Cost optimization potential','Growth enablement security'],
