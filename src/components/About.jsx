        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <Link
                to="/about"
                className="flex items-center justify-center space-x-2 border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg font-semibold hover:border-primary-blue hover:text-primary-blue transition-colors duration-300"
              >
          ...
          >
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8">
              {/* Profile Image */}
              <motion.div
                className="w-48 h-48 mx-auto mb-6 rounded-full overflow-hidden border-4 border-white shadow-lg"
