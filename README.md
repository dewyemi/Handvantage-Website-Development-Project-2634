...
4. **[agents/README.md](./agents/README.md)** — grounding pack for sales / outreach agents trained on the site content. Includes the system prompt, the structured agent context, and the compressed voice rules.
